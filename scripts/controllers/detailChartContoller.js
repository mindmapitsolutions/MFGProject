...
angular.module('sbAdminApp')
  .controller('DetailChartCtrl', ['$scope', '$timeout', '$stateParams', '$state', 'config.Constants', 'config.Service', function ($scope, $timeout, $stateParams, $state, constant, httpService) {

      console.log($stateParams);

      $scope.loadDetailsChart = function(){
      if ($stateParams)
          {
              httpService.httpCall('GET', constant.url.GetCRFData.replace('{CRFId}', $stateParams.CRFID).replace('{PRJId}', $stateParams.prjID), $scope.CRFSuccess, $scope.CRFFailure);
          }
      }
