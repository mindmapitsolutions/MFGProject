...
angular.module('sbAdminApp')
  .controller('TeamChartCtrl', ['$scope', '$timeout', '$stateParams', '$state', 'config.Constants', 'config.Service', function ($scope, $timeout, $stateParams, $state, constant, httpService) {

      $scope.loadTeamChart = function(){
      ...
      $scope.GetCRFSuccess = function(data){
        ...
        $scope.displayChart = function(){
            ...
            httpService.httpCall('GET', constant.url.GetCRFDataTeamWise.replace('{CRFId}', $scope.singleCRF.CRF_ID).replace('{PRJId}', $scope.singleCRF.Project_Id), $scope.CRFSuccess, $scope.CRFFailure);
        }
        ...
        $scope.CRFSuccess = function(data){
                ...
                var CRF_Remaining_Hours = [];
                     angular.forEach(data.CRF.Teams, function (item) {
                         CRF_Labels.push(item.Team_Name);
